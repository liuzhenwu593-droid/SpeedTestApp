...
public class MainActivity extends Activity {
        ...
        mainHandler.post(() -> webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                String script = "(function(){"
                        ...
                        + "var name=(nameBase||'大绿龙优选-results')+'_'+ts+'.'+(ext||'txt');"
    ...
    private String sanitizeFileName(String fileName) {
        String name = fileName == null ? "大绿龙优选-results.txt" : fileName.replaceAll("[\\\\/:*?\"<>|]", "_").trim();
        return name.isEmpty() ? "大绿龙优选-results.txt" : name;
    }
